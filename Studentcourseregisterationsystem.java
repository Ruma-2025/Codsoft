...
public class Studentcourseregisterationsystem {
	private List<Student> students;
    private List<Course> courses;

    public Studentcourseregisterationsystem() {
    ...
    public static void main(String[] args) {
        ...
        Studentcourseregisterationsystem system = new Studentcourseregisterationsystem();
